...
lvm2 ntfs-3g genisoimage mkisofs lshw hwinfo aoetools dmidecode lzop lzma xz-utils pixz lzip pigz pbzip2 lbzip2 plzip lrzip pv hfsutils hfsprogs dmsetup dmraid kpartx tofrodos dos2unix dhcp3-server isc-dhcp-server gdisk btrfs-tools disktype efibootmgr syslinux-utils tftp-server  grub-efi-amd64-bin grub-efi-ia32-bin \
